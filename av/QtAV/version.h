...
#define QTAV_PRODUCT_NAME "Qt" TOSTR(QT_MAJOR_VERSION) "AVWidgets"
#elif defined(BUILD_QMLAV_LIB)
#define QTAV_PRODUCT_NAME "Qt" TOSTR(QT_MAJOR_VERSION) "QmlAV"
#else
#define QTAV_PRODUCT_NAME "Qt" TOSTR(QT_MAJOR_VERSION) "AV"
#endif
